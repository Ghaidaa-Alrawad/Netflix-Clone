...
export default function ModalMovie({
  ...
  async function handleAddFav(e){
    ...
    let response = await fetch(url, {
      method: 'POST',
      headers: {
        //should be from decumintation, WHEEERRREEE????
        ...
        <Modal.Body>
          ...
          <Form onSubmit={(e)=>handleSub(e)}>
            <Form.Group className="mb-3" controlId="formBasicEmail">
              ...
              <Form.Control ref={commentRef} type="text" placeholder="Add you comment here" />
            </Form.Group> 
            <Button variant="primary" type="submit" className="buttonM"
